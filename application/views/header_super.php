...
<head>
	...
	<title>Duta Ryana - SuperAdmin</title>
	<!-- General CSS Files -->
			...
			<div class="main-sidebar sidebar-style-2">
				<aside id="sidebar-wrapper">
					<div class="sidebar-brand">
						<a href="index.html"> <img alt="image" src="<?php echo base_url(); ?>otika/assets/img/logo.png" class="header-logo" /> <span class="logo-name">Duta Ryana</span>
						</a>
					</div>
					<ul class="sidebar-menu">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a class="nav-link" href="<?php echo base_url('AdminLaporanTransaksi'); ?>">Laporan Transaksi</a></li>
								<li><a class="nav-link" href="<?php echo base_url('AdminLaporanService'); ?>">Laporan Service</a></li>
							</ul>
						</li>
						<li class="dropdown">
